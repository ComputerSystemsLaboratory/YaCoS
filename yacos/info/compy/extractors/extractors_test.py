...
def test_llvm_graph_from_several_functions(llvm_extractor_fixture):
    filename = os.path.join(os.path.abspath(os.getcwd()),
                            'yacos/info/compy/extractors/pytest/program_1fn_1.c')
    
    info = llvm_extractor_fixture.GraphFromSource(filename)
    assert len(info.functionInfos) == 1

    filename = os.path.join(os.path.abspath(os.getcwd()),
                            'yacos/info/compy/extractors/pytest/program_2fn.c')
...
def test_llvm_graph_basicblocks_successors_support_loops(llvm_extractor_fixture):
    filename = os.path.join(os.path.abspath(os.getcwd()),
                            'yacos/info/compy/extractors/pytest/program_1fn_3.c')
...
def test_clang_graph_declarations_inner_are_referenced(clang_extractor_fixture):
    filename = os.path.join(os.path.abspath(os.getcwd()),
                            'yacos/info/compy/extractors/pytest/program_1fn_4.c')
