...
class Goals:
    ...
    def goal(goal):
        ...
        if goal == 'llvm_instructions':
            return Goals.llvm_instructions
        elif goal == 'binary_size':
            return Goals.binary_size
        elif goal == 'code_size':
            return Goals.code_size
        elif goal == 'text_size':
            return Goals.text_size
        elif goal == 'data_size':
            return Goals.data_size
        elif goal == 'bss_size':
            return Goals.bss_size
        elif goal == 'compile_time':
            return Goals.compile_time
        elif goal == 'runtime':
            return Goals.runtime
        elif goal == 'cycles':
            return Goals.cycles
